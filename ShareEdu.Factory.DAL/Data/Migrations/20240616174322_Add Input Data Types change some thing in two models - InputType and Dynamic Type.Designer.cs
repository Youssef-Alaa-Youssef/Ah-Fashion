...
namespace ShareEdu.Factory.DAL.Data.Migrations
{
    ...
    [Migration("20240616174322_Add Input Data Types change some thing in two models - InputType and Dynamic Type")]
    partial class AddInputDataTypeschangesomethingintwomodelsInputTypeandDynamicType
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("ShareEdu.Factory.DAL.Models.Employment.JobCategory", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            AddTime = new DateTime(2024, 6, 16, 17, 43, 21, 21, DateTimeKind.Utc).AddTicks(8178),
                            Name = "Software Development"
                        },
                        new
                        {
                            Id = 2,
                            AddTime = new DateTime(2024, 6, 16, 17, 43, 21, 21, DateTimeKind.Utc).AddTicks(8182),
                            Name = "Marketing"
                        },
                        new
                        {
                            Id = 3,
                            AddTime = new DateTime(2024, 6, 16, 17, 43, 21, 21, DateTimeKind.Utc).AddTicks(8185),
                            Name = "Finance"
                        });
                });
            ...
            modelBuilder.Entity("ShareEdu.Factory.DAL.Models.Employment.DynamicInput", b =>
                {
                    ...
                    b.HasOne("ShareEdu.Factory.DAL.Models.Employment.InputType", null)
                        .WithMany("DynamicInputs")
                        .HasForeignKey("InputTypeId1");
